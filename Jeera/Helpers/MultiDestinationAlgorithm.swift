//
//  MultiDestinationAlgorithm.swift
//  Jeera
//
...
public class MultiDestinationAlgorithm {
...
//    }
    ...
    init(currentLocation: CLLocationCoordinate2D, pickAnimals: [String]) {
        // Pick the Chosen Animals to be Searched in the Multi Route Recommendation Feature
        self.pickAnimals = pickAnimals
        
        chooseTheAnimals()
        
        self.currentLocationLong = currentLocation.longitude
        self.currentLocationDict.append(self.currentLocationLong)
        self.currentLocationLat = currentLocation.latitude
        self.currentLocationDict.append(self.currentLocationLat)
